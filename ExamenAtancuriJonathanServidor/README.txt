...
a persistence unit "ExamenAtancuriJonathanServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenAtancuriJonathanServidor\pom.xml":
...
artifact ("ExamenAtancuriJonathanServidor.war") is already built. You can build
